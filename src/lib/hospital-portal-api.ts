...
// Everything in this file backs the hospital claim submission portal --
// gated behind a hospital-type ClaimGuard account (see _hospitalAuth route
// guard), not an anonymous public form. Patient lookup is exact/prefix
// search only (by CHF ID or name), not a browsable roster, to avoid
